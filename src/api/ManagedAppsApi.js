...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V4AppCatalogsResponse', 'model/V4GenericResponse', 'model/V4GetClusterAppsResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V4AppCatalogsResponse'), require('../model/V4GenericResponse'), require('../model/V4GetClusterAppsResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.GiantSwarmV4) {
      root.GiantSwarmV4 = {};
    }
    root.GiantSwarmV4.ManagedAppsApi = factory(root.GiantSwarmV4.ApiClient, root.GiantSwarmV4.V4AppCatalogsResponse, root.GiantSwarmV4.V4GenericResponse, root.GiantSwarmV4.V4GetClusterAppsResponse);
  }
}(this, function(ApiClient, V4AppCatalogsResponse, V4GenericResponse, V4GetClusterAppsResponse) {
  'use strict';

  /**
   * ManagedApps service.
   * @module api/ManagedAppsApi
   * @version 4.0.0
   */

  /**
   * Constructs a new ManagedAppsApi. 
   * @alias module:api/ManagedAppsApi
   * @class
