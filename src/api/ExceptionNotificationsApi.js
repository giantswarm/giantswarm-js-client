...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarm.ExceptionNotificationsApi = factory(root.GiantSwarm.ApiClient, root.GiantSwarm.V4GenericResponse);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.addExceptionNotificationWithHttpInfo = function(body, opts) {
      opts = opts || {};
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addExceptionNotification");
      }
      ...
      return this.apiClient.callApi(
        '/v5/exception-notifications/', 'POST',
     ...
     */
    this.addExceptionNotification = function(body, opts) {
      return this.addExceptionNotificationWithHttpInfo(body, opts)
