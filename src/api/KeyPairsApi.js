...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the addKeyPair operation.
     * @callback module:api/KeyPairsApi~addKeyPairCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V4AddKeyPairResponse} data The data returned by the service call.
     ...
     * @param {module:api/KeyPairsApi~addKeyPairCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V4AddKeyPairResponse}
     */
    this.addKeyPair = function(clusterId, body, callback) {
      var postBody = body;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/V4GetKeyPairsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/V4GetKeyPairsResponse}
     */
    this.getKeyPairs = function(clusterId, callback) {
      var postBody = null;
