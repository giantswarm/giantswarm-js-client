...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarm.InfoApi = factory(root.GiantSwarm.ApiClient, root.GiantSwarm.V4GenericResponse, root.GiantSwarm.V4InfoResponse);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getInfoWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.getInfo = function(opts) {
      return this.getInfoWithHttpInfo(opts)
