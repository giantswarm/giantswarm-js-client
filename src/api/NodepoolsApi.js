...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V4GenericResponse', 'model/V5AddNodePoolRequest', 'model/V5GetNodePoolResponse', 'model/V5GetNodePoolStatusResponse', 'model/V5GetNodePoolsResponse', 'model/V5ModifyNodePoolRequest'], factory);
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.xGiantSwarmActivity Name of an activity to track, like \&quot;list-clusters\&quot;. This allows to analyze several API requests sent in context and gives an idea on the purpose. 
     * @param {String} opts.xGiantSwarmCmdLine If activity has been issued by a CLI, this header can contain the command line 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/V5GetNodePoolStatusResponse} and HTTP response
     */
    this.getNodePoolStatusWithHttpInfo = function(authorization, clusterId, opts) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = V5GetNodePoolStatusResponse;

      return this.apiClient.callApi(
        '/v5/clusters/{cluster_id}/nodepools/{nodepool_id}/status/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @param {String} opts.xGiantSwarmActivity Name of an activity to track, like \&quot;list-clusters\&quot;. This allows to analyze several API requests sent in context and gives an idea on the purpose. 
     * @param {String} opts.xGiantSwarmCmdLine If activity has been issued by a CLI, this header can contain the command line 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/V5GetNodePoolStatusResponse}
     */
