...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V4GenericResponse', 'model/V5AddNodePoolRequest', 'model/V5GetNodePoolResponse', 'model/V5ModifyNodePoolRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V4GenericResponse'), require('../model/V5AddNodePoolRequest'), require('../model/V5GetNodePoolResponse'), require('../model/V5ModifyNodePoolRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.GiantSwarm) {
      root.GiantSwarm = {};
    }
    root.GiantSwarm.NodepoolsApi = factory(root.GiantSwarm.ApiClient, root.GiantSwarm.V4GenericResponse, root.GiantSwarm.V5AddNodePoolRequest, root.GiantSwarm.V5GetNodePoolResponse, root.GiantSwarm.V5ModifyNodePoolRequest);
  }
}(this, function(ApiClient, V4GenericResponse, V5AddNodePoolRequest, V5GetNodePoolResponse, V5ModifyNodePoolRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.xGiantSwarmActivity Name of an activity to track, like \"list-clusters\". This allows to analyze several API requests sent in context and gives an idea on the purpose. 
     * @param {String} opts.xGiantSwarmCmdLine If activity has been issued by a CLI, this header can contain the command line 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/V5GetNodePoolResponse>} and HTTP response
     */
     ...
     * @param {String} opts.xGiantSwarmActivity Name of an activity to track, like \"list-clusters\". This allows to analyze several API requests sent in context and gives an idea on the purpose. 
     * @param {String} opts.xGiantSwarmCmdLine If activity has been issued by a CLI, this header can contain the command line 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/V5GetNodePoolResponse>}
     */
