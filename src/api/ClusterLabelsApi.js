  ...
  var exports = function(apiClient) {
    ...
    this.getClusterLabelsWithHttpInfo = function(clusterId, opts) {
      ...
      if (clusterId === undefined || clusterId === null) {
        throw new Error("Missing the required parameter 'clusterId' when calling getClusterLabels");
      }
      ...
      var returnType = V5ClusterLabelsResponse;

      return this.apiClient.callApi(
        '/v5/clusters/{cluster_id}/labels/', 'GET',
    ...
    this.setClusterLabelsWithHttpInfo = function(clusterId, body, opts) {
      ...
      // verify the required parameter 'clusterId' is set
      if (clusterId === undefined || clusterId === null) {
        throw new Error("Missing the required parameter 'clusterId' when calling setClusterLabels");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling setClusterLabels");
      }
      ...
      return this.apiClient.callApi(
        '/v5/clusters/{cluster_id}/labels/', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
