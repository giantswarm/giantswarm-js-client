...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V4AddClusterRequest', 'model/V4ClusterDetailsResponse', 'model/V4ClusterListItem', 'model/V4GenericResponse', 'model/V4ModifyClusterRequest', 'model/V5AddClusterRequest', 'model/V5ClusterDetailsResponse', 'model/V5ModifyClusterRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V4AddClusterRequest'), require('../model/V4ClusterDetailsResponse'), require('../model/V4ClusterListItem'), require('../model/V4GenericResponse'), require('../model/V4ModifyClusterRequest'), require('../model/V5AddClusterRequest'), require('../model/V5ClusterDetailsResponse'), require('../model/V5ModifyClusterRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.GiantSwarm) {
      root.GiantSwarm = {};
    }
    root.GiantSwarm.ClustersApi = factory(root.GiantSwarm.ApiClient, root.GiantSwarm.V4AddClusterRequest, root.GiantSwarm.V4ClusterDetailsResponse, root.GiantSwarm.V4ClusterListItem, root.GiantSwarm.V4GenericResponse, root.GiantSwarm.V4ModifyClusterRequest, root.GiantSwarm.V5AddClusterRequest, root.GiantSwarm.V5ClusterDetailsResponse, root.GiantSwarm.V5ModifyClusterRequest);
  }
}(this, function(ApiClient, V4AddClusterRequest, V4ClusterDetailsResponse, V4ClusterListItem, V4GenericResponse, V4ModifyClusterRequest, V5AddClusterRequest, V5ClusterDetailsResponse, V5ModifyClusterRequest) {
  'use strict';
