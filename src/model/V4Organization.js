...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V4OrganizationMember'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V4OrganizationMember'));
  } else {
    // Browser globals (root is window)
    if (!root.GiantSwarmV4) {
      root.GiantSwarmV4 = {};
    }
    root.GiantSwarmV4.V4Organization = factory(root.GiantSwarmV4.ApiClient, root.GiantSwarmV4.V4OrganizationMember);
  }
}(this, function(ApiClient, V4OrganizationMember) {
  'use strict';
