...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V5GetNodePoolResponseNodeSpecAws', 'model/V5GetNodePoolResponseNodeSpecVolumeSizesGb'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V5GetNodePoolResponseNodeSpecAws'), require('./V5GetNodePoolResponseNodeSpecVolumeSizesGb'));
  } else {
    // Browser globals (root is window)
    if (!root.GiantSwarmV4) {
      root.GiantSwarmV4 = {};
    }
    root.GiantSwarmV4.V5GetNodePoolResponseNodeSpec = factory(root.GiantSwarmV4.ApiClient, root.GiantSwarmV4.V5GetNodePoolResponseNodeSpecAws, root.GiantSwarmV4.V5GetNodePoolResponseNodeSpecVolumeSizesGb);
  }
}(this, function(ApiClient, V5GetNodePoolResponseNodeSpecAws, V5GetNodePoolResponseNodeSpecVolumeSizesGb) {
  'use strict';
