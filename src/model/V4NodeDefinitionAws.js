...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V4NodeDefinitionAws = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V4NodeDefinitionAws</code>.
   * Attributes specific to nodes running on Amazon Web Services (AWS) 
   * @alias module:model/V4NodeDefinitionAws
   * @class
   */
