...
(function(root, factory) {
   ...
   * @class
   * @param availabilityZones {module:model/V4InfoResponseGeneralAvailabilityZones} 
   */
  var exports = function(availabilityZones) {
    var _this = this;

    _this['availability_zones'] = availabilityZones;
  };
