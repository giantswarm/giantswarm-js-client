...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V4GetClusterAppsResponseInner'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V4GetClusterAppsResponseInner'));
  } else {
    // Browser globals (root is window)
    if (!root.GiantSwarmV4) {
      root.GiantSwarmV4 = {};
    }
    root.GiantSwarmV4.V4GetClusterAppsResponse = factory(root.GiantSwarmV4.ApiClient, root.GiantSwarmV4.V4GetClusterAppsResponseInner);
  }
}(this, function(ApiClient, V4GetClusterAppsResponseInner) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'V4GetClusterAppsResponseInner');
