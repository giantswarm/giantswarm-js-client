...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V4InfoResponseStatsClusterCreationDuration = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V4InfoResponseStatsClusterCreationDuration</code>.
   * Duration of cluster creation, summarized.
   * @alias module:model/V4InfoResponseStatsClusterCreationDuration
   * @class
   */
   ...
   * @member {Number} p75
   */
  exports.prototype['p75'] = undefined;
