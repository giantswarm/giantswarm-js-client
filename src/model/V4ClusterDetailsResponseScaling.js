...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V4ClusterDetailsResponseScaling = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V4ClusterDetailsResponseScaling</code>.
   * Attributes specific to cluster node scaling as set during cluster creation or cluster scaling. 
   * @alias module:model/V4ClusterDetailsResponseScaling
   * @class
   */
