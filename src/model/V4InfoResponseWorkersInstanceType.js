...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V4InfoResponseWorkersInstanceType = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V4InfoResponseWorkersInstanceType</code>.
   * Instance types to be used for worker nodes. Only available for AWS clusters.
   * @alias module:model/V4InfoResponseWorkersInstanceType
   * @class
   */
