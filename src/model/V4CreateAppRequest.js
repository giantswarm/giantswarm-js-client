...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V4CreateAppRequestSpec'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V4CreateAppRequestSpec'));
  } else {
    // Browser globals (root is window)
    if (!root.GiantSwarmV4) {
      root.GiantSwarmV4 = {};
    }
    root.GiantSwarmV4.V4CreateAppRequest = factory(root.GiantSwarmV4.ApiClient, root.GiantSwarmV4.V4CreateAppRequestSpec);
  }
}(this, function(ApiClient, V4CreateAppRequestSpec) {
  'use strict';
  ...
  /**
   * Constructs a new <code>V4CreateAppRequest</code>.
   * A part of the App CR that we create behind the scenes
   * @alias module:model/V4CreateAppRequest
   * @class
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('spec')) {
        obj['spec'] = V4CreateAppRequestSpec.constructFromObject(data['spec']);
      }
    }
    return obj;
  }
