...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V5AddClusterRequestMasterNodesAzure'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V5AddClusterRequestMasterNodesAzure'));
  } else {
    // Browser globals (root is window)
    if (!root.GiantSwarm) {
      root.GiantSwarm = {};
    }
    root.GiantSwarm.V5AddClusterRequestMasterNodes = factory(root.GiantSwarm.ApiClient, root.GiantSwarm.V5AddClusterRequestMasterNodesAzure);
  }
}(this, function(ApiClient, V5AddClusterRequestMasterNodesAzure) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('azure')) {
        obj['azure'] = V5AddClusterRequestMasterNodesAzure.constructFromObject(data['azure']);
      }
    }
    return obj;
  }
