...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V5ClusterDetailsResponseConditions = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V5ClusterDetailsResponseConditions</code>.
   * @alias module:model/V5ClusterDetailsResponseConditions
   * @class
   */
