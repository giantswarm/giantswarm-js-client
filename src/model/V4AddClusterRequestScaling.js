...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V4AddClusterRequestScaling = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V4AddClusterRequestScaling</code>.
   ...
   * @alias module:model/V4AddClusterRequestScaling
   * @class
   */
