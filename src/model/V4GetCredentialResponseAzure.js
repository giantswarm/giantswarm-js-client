...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V4GetCredentialResponseAzureCredential'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V4GetCredentialResponseAzureCredential'));
  } else {
    // Browser globals (root is window)
    if (!root.GiantSwarmV4) {
      root.GiantSwarmV4 = {};
    }
    root.GiantSwarmV4.V4GetCredentialResponseAzure = factory(root.GiantSwarmV4.ApiClient, root.GiantSwarmV4.V4GetCredentialResponseAzureCredential);
  }
}(this, function(ApiClient, V4GetCredentialResponseAzureCredential) {
  'use strict';
  ...
  /**
   * Constructs a new <code>V4GetCredentialResponseAzure</code>.
   * Credentials specific to an Azure service principal
   * @alias module:model/V4GetCredentialResponseAzure
   * @class
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('credential')) {
        obj['credential'] = V4GetCredentialResponseAzureCredential.constructFromObject(data['credential']);
      }
    }
    return obj;
  }
