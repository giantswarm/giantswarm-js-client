...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V4NodeDefinitionStorage = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V4NodeDefinitionStorage</code>.
   * @alias module:model/V4NodeDefinitionStorage
   * @class
   */
