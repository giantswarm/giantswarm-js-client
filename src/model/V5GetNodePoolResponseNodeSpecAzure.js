...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V5GetNodePoolResponseNodeSpecAzureSpotInstances'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V5GetNodePoolResponseNodeSpecAzureSpotInstances'));
  } else {
    // Browser globals (root is window)
    if (!root.GiantSwarm) {
      root.GiantSwarm = {};
    }
    root.GiantSwarm.V5GetNodePoolResponseNodeSpecAzure = factory(root.GiantSwarm.ApiClient, root.GiantSwarm.V5GetNodePoolResponseNodeSpecAzureSpotInstances);
  }
}(this, function(ApiClient, V5GetNodePoolResponseNodeSpecAzureSpotInstances) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('spot_instances')) {
        obj['spot_instances'] = V5GetNodePoolResponseNodeSpecAzureSpotInstances.constructFromObject(data['spot_instances']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/V5GetNodePoolResponseNodeSpecAzureSpotInstances} spot_instances
   */
