...
(function(root, factory) {
   ...
   * @param active {Boolean} If `true`, the version is recommended for use in cluster creation and cluster upgrades. Older versions become unavailable and thus have the value `false` here. Cluster creation with this version is still possible but not recommended. 
   ...
   */
  var exports = function(version, timestamp, active, changelog, components) {
    var _this = this;
  ...
  /**
   * If `true`, the version is recommended for use in cluster creation and cluster upgrades. Older versions become unavailable and thus have the value `false` here. Cluster creation with this version is still possible but not recommended. 
