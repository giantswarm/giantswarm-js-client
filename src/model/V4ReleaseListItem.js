...
(function(root, factory) {
   ...
   * @param active {Boolean} If true, the version is available for new clusters and cluster upgrades. Older versions become unavailable and thus have the value `false` here. 
