...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V4NodeDefinitionCpu = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V4NodeDefinitionCpu</code>.
   * @alias module:model/V4NodeDefinitionCpu
   * @class
   */
