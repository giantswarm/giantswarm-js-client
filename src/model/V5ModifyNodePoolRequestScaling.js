...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V5ModifyNodePoolRequestScaling = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V5ModifyNodePoolRequestScaling</code>.
   ...
   * @alias module:model/V5ModifyNodePoolRequestScaling
   * @class
   */
