...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V4AppCatalogsResponseInnerSpecStorage = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V4AppCatalogsResponseInnerSpecStorage</code>.
   * Contains information on where to find the full catalog, and what type of catalog it is.
   * @alias module:model/V4AppCatalogsResponseInnerSpecStorage
   * @class
   */
