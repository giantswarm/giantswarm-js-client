...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V5AddNodePoolRequestNodeSpecAzureSpotInstances'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V5AddNodePoolRequestNodeSpecAzureSpotInstances'));
  } else {
    // Browser globals (root is window)
    if (!root.GiantSwarm) {
      root.GiantSwarm = {};
    }
    root.GiantSwarm.V5AddNodePoolRequestNodeSpecAzure = factory(root.GiantSwarm.ApiClient, root.GiantSwarm.V5AddNodePoolRequestNodeSpecAzureSpotInstances);
  }
}(this, function(ApiClient, V5AddNodePoolRequestNodeSpecAzureSpotInstances) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('spot_instances')) {
        obj['spot_instances'] = V5AddNodePoolRequestNodeSpecAzureSpotInstances.constructFromObject(data['spot_instances']);
      }
    }
    return obj;
  }
