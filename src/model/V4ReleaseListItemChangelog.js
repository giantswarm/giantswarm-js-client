...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V4ReleaseListItemChangelog = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V4ReleaseListItemChangelog</code>.
   * @alias module:model/V4ReleaseListItemChangelog
   * @class
   */
