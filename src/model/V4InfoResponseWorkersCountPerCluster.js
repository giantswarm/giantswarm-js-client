...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V4InfoResponseWorkersCountPerCluster = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V4InfoResponseWorkersCountPerCluster</code>.
   * Number of workers per cluster
   * @alias module:model/V4InfoResponseWorkersCountPerCluster
   * @class
   */
