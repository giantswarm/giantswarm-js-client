...
import V4GetKeyPairsResponseInner from './V4GetKeyPairsResponseInner';
...
* @version 4.0.0
*/
export default class V4GetKeyPairsResponse extends Array {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V4GetKeyPairsResponse();
