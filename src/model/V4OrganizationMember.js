...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GiantSwarmV4.V4OrganizationMember = factory(root.GiantSwarmV4.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>V4OrganizationMember</code>.
   * @alias module:model/V4OrganizationMember
   * @class
   */
