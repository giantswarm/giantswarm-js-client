...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Body', 'model/V4AddClusterRequest', 'model/V4AddClusterRequestScaling', 'model/V4AddCredentialsRequest', 'model/V4AddCredentialsRequestAws', 'model/V4AddCredentialsRequestAwsRoles', 'model/V4AddCredentialsRequestAzure', 'model/V4AddCredentialsRequestAzureCredential', 'model/V4AddKeyPairRequest', 'model/V4AddKeyPairResponse', 'model/V4AppCatalogsResponse', 'model/V4ClusterDetailsResponse', 'model/V4ClusterDetailsResponseKvm', 'model/V4ClusterDetailsResponseKvmPortMappings', 'model/V4ClusterDetailsResponseScaling', 'model/V4ClusterListItem', 'model/V4CreateAuthTokenRequest', 'model/V4CreateAuthTokenResponse', 'model/V4CreateUserRequest', 'model/V4GenericResponse', 'model/V4GetClusterAppsResponse', 'model/V4GetClusterAppsResponseInner', 'model/V4GetClusterAppsResponseInnerMetadata', 'model/V4GetClusterAppsResponseInnerSpec', 'model/V4GetClusterAppsResponseInnerStatus', 'model/V4GetClusterAppsResponseInnerStatusRelease', 'model/V4GetClusterStatusResponse', 'model/V4GetCredentialResponse', 'model/V4GetCredentialResponseAws', 'model/V4GetCredentialResponseAwsRoles', 'model/V4GetCredentialResponseAzure', 'model/V4GetCredentialResponseAzureCredential', 'model/V4GetCredentialsResponse', 'model/V4GetKeyPairsResponse', 'model/V4GetKeyPairsResponseInner', 'model/V4InfoResponse', 'model/V4InfoResponseGeneral', 'model/V4InfoResponseGeneralAvailabilityZones', 'model/V4InfoResponseWorkers', 'model/V4InfoResponseWorkersCountPerCluster', 'model/V4InfoResponseWorkersInstanceType', 'model/V4InfoResponseWorkersVmSize', 'model/V4ModifyClusterRequest', 'model/V4ModifyClusterRequestScaling', 'model/V4ModifyUserPasswordRequest', 'model/V4ModifyUserRequest', 'model/V4NodeDefinition', 'model/V4NodeDefinitionAws', 'model/V4NodeDefinitionAzure', 'model/V4NodeDefinitionCpu', 'model/V4NodeDefinitionMemory', 'model/V4NodeDefinitionStorage', 'model/V4Organization', 'model/V4OrganizationListItem', 'model/V4OrganizationMember', 'model/V4ReleaseListItem', 'model/V4ReleaseListItemChangelog', 'model/V4ReleaseListItemComponents', 'model/V4UserListItem', 'api/AuthTokensApi', 'api/ClustersApi', 'api/InfoApi', 'api/KeyPairsApi', 'api/ManagedAppsApi', 'api/OrganizationsApi', 'api/ReleasesApi', 'api/UsersApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Body'), require('./model/V4AddClusterRequest'), require('./model/V4AddClusterRequestScaling'), require('./model/V4AddCredentialsRequest'), require('./model/V4AddCredentialsRequestAws'), require('./model/V4AddCredentialsRequestAwsRoles'), require('./model/V4AddCredentialsRequestAzure'), require('./model/V4AddCredentialsRequestAzureCredential'), require('./model/V4AddKeyPairRequest'), require('./model/V4AddKeyPairResponse'), require('./model/V4AppCatalogsResponse'), require('./model/V4ClusterDetailsResponse'), require('./model/V4ClusterDetailsResponseKvm'), require('./model/V4ClusterDetailsResponseKvmPortMappings'), require('./model/V4ClusterDetailsResponseScaling'), require('./model/V4ClusterListItem'), require('./model/V4CreateAuthTokenRequest'), require('./model/V4CreateAuthTokenResponse'), require('./model/V4CreateUserRequest'), require('./model/V4GenericResponse'), require('./model/V4GetClusterAppsResponse'), require('./model/V4GetClusterAppsResponseInner'), require('./model/V4GetClusterAppsResponseInnerMetadata'), require('./model/V4GetClusterAppsResponseInnerSpec'), require('./model/V4GetClusterAppsResponseInnerStatus'), require('./model/V4GetClusterAppsResponseInnerStatusRelease'), require('./model/V4GetClusterStatusResponse'), require('./model/V4GetCredentialResponse'), require('./model/V4GetCredentialResponseAws'), require('./model/V4GetCredentialResponseAwsRoles'), require('./model/V4GetCredentialResponseAzure'), require('./model/V4GetCredentialResponseAzureCredential'), require('./model/V4GetCredentialsResponse'), require('./model/V4GetKeyPairsResponse'), require('./model/V4GetKeyPairsResponseInner'), require('./model/V4InfoResponse'), require('./model/V4InfoResponseGeneral'), require('./model/V4InfoResponseGeneralAvailabilityZones'), require('./model/V4InfoResponseWorkers'), require('./model/V4InfoResponseWorkersCountPerCluster'), require('./model/V4InfoResponseWorkersInstanceType'), require('./model/V4InfoResponseWorkersVmSize'), require('./model/V4ModifyClusterRequest'), require('./model/V4ModifyClusterRequestScaling'), require('./model/V4ModifyUserPasswordRequest'), require('./model/V4ModifyUserRequest'), require('./model/V4NodeDefinition'), require('./model/V4NodeDefinitionAws'), require('./model/V4NodeDefinitionAzure'), require('./model/V4NodeDefinitionCpu'), require('./model/V4NodeDefinitionMemory'), require('./model/V4NodeDefinitionStorage'), require('./model/V4Organization'), require('./model/V4OrganizationListItem'), require('./model/V4OrganizationMember'), require('./model/V4ReleaseListItem'), require('./model/V4ReleaseListItemChangelog'), require('./model/V4ReleaseListItemComponents'), require('./model/V4UserListItem'), require('./api/AuthTokensApi'), require('./api/ClustersApi'), require('./api/InfoApi'), require('./api/KeyPairsApi'), require('./api/ManagedAppsApi'), require('./api/OrganizationsApi'), require('./api/ReleasesApi'), require('./api/UsersApi'));
  }
}(function(ApiClient, Body, V4AddClusterRequest, V4AddClusterRequestScaling, V4AddCredentialsRequest, V4AddCredentialsRequestAws, V4AddCredentialsRequestAwsRoles, V4AddCredentialsRequestAzure, V4AddCredentialsRequestAzureCredential, V4AddKeyPairRequest, V4AddKeyPairResponse, V4AppCatalogsResponse, V4ClusterDetailsResponse, V4ClusterDetailsResponseKvm, V4ClusterDetailsResponseKvmPortMappings, V4ClusterDetailsResponseScaling, V4ClusterListItem, V4CreateAuthTokenRequest, V4CreateAuthTokenResponse, V4CreateUserRequest, V4GenericResponse, V4GetClusterAppsResponse, V4GetClusterAppsResponseInner, V4GetClusterAppsResponseInnerMetadata, V4GetClusterAppsResponseInnerSpec, V4GetClusterAppsResponseInnerStatus, V4GetClusterAppsResponseInnerStatusRelease, V4GetClusterStatusResponse, V4GetCredentialResponse, V4GetCredentialResponseAws, V4GetCredentialResponseAwsRoles, V4GetCredentialResponseAzure, V4GetCredentialResponseAzureCredential, V4GetCredentialsResponse, V4GetKeyPairsResponse, V4GetKeyPairsResponseInner, V4InfoResponse, V4InfoResponseGeneral, V4InfoResponseGeneralAvailabilityZones, V4InfoResponseWorkers, V4InfoResponseWorkersCountPerCluster, V4InfoResponseWorkersInstanceType, V4InfoResponseWorkersVmSize, V4ModifyClusterRequest, V4ModifyClusterRequestScaling, V4ModifyUserPasswordRequest, V4ModifyUserRequest, V4NodeDefinition, V4NodeDefinitionAws, V4NodeDefinitionAzure, V4NodeDefinitionCpu, V4NodeDefinitionMemory, V4NodeDefinitionStorage, V4Organization, V4OrganizationListItem, V4OrganizationMember, V4ReleaseListItem, V4ReleaseListItemChangelog, V4ReleaseListItemComponents, V4UserListItem, AuthTokensApi, ClustersApi, InfoApi, KeyPairsApi, ManagedAppsApi, OrganizationsApi, ReleasesApi, UsersApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The V4GetClusterAppsResponseInner model constructor.
     * @property {module:model/V4GetClusterAppsResponseInner}
     */
    V4GetClusterAppsResponseInner: V4GetClusterAppsResponseInner,
    /**
     * The V4GetClusterAppsResponseInnerMetadata model constructor.
     * @property {module:model/V4GetClusterAppsResponseInnerMetadata}
     */
    V4GetClusterAppsResponseInnerMetadata: V4GetClusterAppsResponseInnerMetadata,
    /**
     * The V4GetClusterAppsResponseInnerSpec model constructor.
     * @property {module:model/V4GetClusterAppsResponseInnerSpec}
     */
    V4GetClusterAppsResponseInnerSpec: V4GetClusterAppsResponseInnerSpec,
    /**
     * The V4GetClusterAppsResponseInnerStatus model constructor.
     * @property {module:model/V4GetClusterAppsResponseInnerStatus}
     */
    V4GetClusterAppsResponseInnerStatus: V4GetClusterAppsResponseInnerStatus,
    /**
     * The V4GetClusterAppsResponseInnerStatusRelease model constructor.
     * @property {module:model/V4GetClusterAppsResponseInnerStatusRelease}
     */
    V4GetClusterAppsResponseInnerStatusRelease: V4GetClusterAppsResponseInnerStatusRelease,
    /**
    ...
    /**
     * The ManagedAppsApi service constructor.
     * @property {module:api/ManagedAppsApi}
     */
    ManagedAppsApi: ManagedAppsApi,
    /**
