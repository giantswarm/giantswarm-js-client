...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Body', 'model/V4AddClusterRequest', 'model/V4AddCredentialsRequest', 'model/V4AddCredentialsRequestAws', 'model/V4AddCredentialsRequestAwsRoles', 'model/V4AddCredentialsRequestAzure', 'model/V4AddCredentialsRequestAzureCredential', 'model/V4AddKeyPairRequest', 'model/V4AddKeyPairResponse', 'model/V4ClusterDetailsResponse', 'model/V4ClusterDetailsResponseKvm', 'model/V4ClusterDetailsResponseKvmPortMappings', 'model/V4ClusterListItem', 'model/V4CreateAuthTokenRequest', 'model/V4CreateAuthTokenResponse', 'model/V4CreateUserRequest', 'model/V4GenericResponse', 'model/V4GetClusterStatusResponse', 'model/V4GetClusterStatusResponseAws', 'model/V4GetClusterStatusResponseAwsAvailabilityZones', 'model/V4GetClusterStatusResponseAwsSubnet', 'model/V4GetClusterStatusResponseAwsSubnetPrivate', 'model/V4GetClusterStatusResponseAwsSubnetPublic', 'model/V4GetClusterStatusResponseCluster', 'model/V4GetClusterStatusResponseClusterConditions', 'model/V4GetClusterStatusResponseClusterNetwork', 'model/V4GetClusterStatusResponseClusterNodes', 'model/V4GetClusterStatusResponseClusterResources', 'model/V4GetClusterStatusResponseClusterScaling', 'model/V4GetClusterStatusResponseClusterVersions', 'model/V4GetCredentialResponse', 'model/V4GetCredentialResponseAws', 'model/V4GetCredentialResponseAwsRoles', 'model/V4GetCredentialResponseAzure', 'model/V4GetCredentialResponseAzureCredential', 'model/V4GetCredentialsResponse', 'model/V4GetKeyPairsResponse', 'model/V4GetKeyPairsResponseInner', 'model/V4InfoResponse', 'model/V4InfoResponseGeneral', 'model/V4InfoResponseGeneralAvailabilityZones', 'model/V4InfoResponseWorkers', 'model/V4InfoResponseWorkersCountPerCluster', 'model/V4InfoResponseWorkersInstanceType', 'model/V4InfoResponseWorkersVmSize', 'model/V4ModifyClusterRequest', 'model/V4ModifyUserPasswordRequest', 'model/V4ModifyUserRequest', 'model/V4NodeDefinition', 'model/V4NodeDefinitionAws', 'model/V4NodeDefinitionAzure', 'model/V4NodeDefinitionCpu', 'model/V4NodeDefinitionMemory', 'model/V4NodeDefinitionStorage', 'model/V4Organization', 'model/V4OrganizationListItem', 'model/V4OrganizationMember', 'model/V4ReleaseListItem', 'model/V4ReleaseListItemChangelog', 'model/V4ReleaseListItemComponents', 'model/V4UserListItem', 'api/AuthTokensApi', 'api/ClustersApi', 'api/InfoApi', 'api/KeyPairsApi', 'api/OrganizationsApi', 'api/ReleasesApi', 'api/UsersApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Body'), require('./model/V4AddClusterRequest'), require('./model/V4AddCredentialsRequest'), require('./model/V4AddCredentialsRequestAws'), require('./model/V4AddCredentialsRequestAwsRoles'), require('./model/V4AddCredentialsRequestAzure'), require('./model/V4AddCredentialsRequestAzureCredential'), require('./model/V4AddKeyPairRequest'), require('./model/V4AddKeyPairResponse'), require('./model/V4ClusterDetailsResponse'), require('./model/V4ClusterDetailsResponseKvm'), require('./model/V4ClusterDetailsResponseKvmPortMappings'), require('./model/V4ClusterListItem'), require('./model/V4CreateAuthTokenRequest'), require('./model/V4CreateAuthTokenResponse'), require('./model/V4CreateUserRequest'), require('./model/V4GenericResponse'), require('./model/V4GetClusterStatusResponse'), require('./model/V4GetClusterStatusResponseAws'), require('./model/V4GetClusterStatusResponseAwsAvailabilityZones'), require('./model/V4GetClusterStatusResponseAwsSubnet'), require('./model/V4GetClusterStatusResponseAwsSubnetPrivate'), require('./model/V4GetClusterStatusResponseAwsSubnetPublic'), require('./model/V4GetClusterStatusResponseCluster'), require('./model/V4GetClusterStatusResponseClusterConditions'), require('./model/V4GetClusterStatusResponseClusterNetwork'), require('./model/V4GetClusterStatusResponseClusterNodes'), require('./model/V4GetClusterStatusResponseClusterResources'), require('./model/V4GetClusterStatusResponseClusterScaling'), require('./model/V4GetClusterStatusResponseClusterVersions'), require('./model/V4GetCredentialResponse'), require('./model/V4GetCredentialResponseAws'), require('./model/V4GetCredentialResponseAwsRoles'), require('./model/V4GetCredentialResponseAzure'), require('./model/V4GetCredentialResponseAzureCredential'), require('./model/V4GetCredentialsResponse'), require('./model/V4GetKeyPairsResponse'), require('./model/V4GetKeyPairsResponseInner'), require('./model/V4InfoResponse'), require('./model/V4InfoResponseGeneral'), require('./model/V4InfoResponseGeneralAvailabilityZones'), require('./model/V4InfoResponseWorkers'), require('./model/V4InfoResponseWorkersCountPerCluster'), require('./model/V4InfoResponseWorkersInstanceType'), require('./model/V4InfoResponseWorkersVmSize'), require('./model/V4ModifyClusterRequest'), require('./model/V4ModifyUserPasswordRequest'), require('./model/V4ModifyUserRequest'), require('./model/V4NodeDefinition'), require('./model/V4NodeDefinitionAws'), require('./model/V4NodeDefinitionAzure'), require('./model/V4NodeDefinitionCpu'), require('./model/V4NodeDefinitionMemory'), require('./model/V4NodeDefinitionStorage'), require('./model/V4Organization'), require('./model/V4OrganizationListItem'), require('./model/V4OrganizationMember'), require('./model/V4ReleaseListItem'), require('./model/V4ReleaseListItemChangelog'), require('./model/V4ReleaseListItemComponents'), require('./model/V4UserListItem'), require('./api/AuthTokensApi'), require('./api/ClustersApi'), require('./api/InfoApi'), require('./api/KeyPairsApi'), require('./api/OrganizationsApi'), require('./api/ReleasesApi'), require('./api/UsersApi'));
  }
}(function(ApiClient, Body, V4AddClusterRequest, V4AddCredentialsRequest, V4AddCredentialsRequestAws, V4AddCredentialsRequestAwsRoles, V4AddCredentialsRequestAzure, V4AddCredentialsRequestAzureCredential, V4AddKeyPairRequest, V4AddKeyPairResponse, V4ClusterDetailsResponse, V4ClusterDetailsResponseKvm, V4ClusterDetailsResponseKvmPortMappings, V4ClusterListItem, V4CreateAuthTokenRequest, V4CreateAuthTokenResponse, V4CreateUserRequest, V4GenericResponse, V4GetClusterStatusResponse, V4GetClusterStatusResponseAws, V4GetClusterStatusResponseAwsAvailabilityZones, V4GetClusterStatusResponseAwsSubnet, V4GetClusterStatusResponseAwsSubnetPrivate, V4GetClusterStatusResponseAwsSubnetPublic, V4GetClusterStatusResponseCluster, V4GetClusterStatusResponseClusterConditions, V4GetClusterStatusResponseClusterNetwork, V4GetClusterStatusResponseClusterNodes, V4GetClusterStatusResponseClusterResources, V4GetClusterStatusResponseClusterScaling, V4GetClusterStatusResponseClusterVersions, V4GetCredentialResponse, V4GetCredentialResponseAws, V4GetCredentialResponseAwsRoles, V4GetCredentialResponseAzure, V4GetCredentialResponseAzureCredential, V4GetCredentialsResponse, V4GetKeyPairsResponse, V4GetKeyPairsResponseInner, V4InfoResponse, V4InfoResponseGeneral, V4InfoResponseGeneralAvailabilityZones, V4InfoResponseWorkers, V4InfoResponseWorkersCountPerCluster, V4InfoResponseWorkersInstanceType, V4InfoResponseWorkersVmSize, V4ModifyClusterRequest, V4ModifyUserPasswordRequest, V4ModifyUserRequest, V4NodeDefinition, V4NodeDefinitionAws, V4NodeDefinitionAzure, V4NodeDefinitionCpu, V4NodeDefinitionMemory, V4NodeDefinitionStorage, V4Organization, V4OrganizationListItem, V4OrganizationMember, V4ReleaseListItem, V4ReleaseListItemChangelog, V4ReleaseListItemComponents, V4UserListItem, AuthTokensApi, ClustersApi, InfoApi, KeyPairsApi, OrganizationsApi, ReleasesApi, UsersApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The V4GetClusterStatusResponseAws model constructor.
     * @property {module:model/V4GetClusterStatusResponseAws}
     */
    V4GetClusterStatusResponseAws: V4GetClusterStatusResponseAws,
    /**
     * The V4GetClusterStatusResponseAwsAvailabilityZones model constructor.
     * @property {module:model/V4GetClusterStatusResponseAwsAvailabilityZones}
     */
    V4GetClusterStatusResponseAwsAvailabilityZones: V4GetClusterStatusResponseAwsAvailabilityZones,
    /**
     * The V4GetClusterStatusResponseAwsSubnet model constructor.
     * @property {module:model/V4GetClusterStatusResponseAwsSubnet}
     */
    V4GetClusterStatusResponseAwsSubnet: V4GetClusterStatusResponseAwsSubnet,
    /**
     * The V4GetClusterStatusResponseAwsSubnetPrivate model constructor.
     * @property {module:model/V4GetClusterStatusResponseAwsSubnetPrivate}
     */
    V4GetClusterStatusResponseAwsSubnetPrivate: V4GetClusterStatusResponseAwsSubnetPrivate,
    /**
     * The V4GetClusterStatusResponseAwsSubnetPublic model constructor.
     * @property {module:model/V4GetClusterStatusResponseAwsSubnetPublic}
     */
    V4GetClusterStatusResponseAwsSubnetPublic: V4GetClusterStatusResponseAwsSubnetPublic,
    /**
     * The V4GetClusterStatusResponseCluster model constructor.
     * @property {module:model/V4GetClusterStatusResponseCluster}
     */
    V4GetClusterStatusResponseCluster: V4GetClusterStatusResponseCluster,
    /**
     * The V4GetClusterStatusResponseClusterConditions model constructor.
     * @property {module:model/V4GetClusterStatusResponseClusterConditions}
     */
    V4GetClusterStatusResponseClusterConditions: V4GetClusterStatusResponseClusterConditions,
    /**
     * The V4GetClusterStatusResponseClusterNetwork model constructor.
     * @property {module:model/V4GetClusterStatusResponseClusterNetwork}
     */
    V4GetClusterStatusResponseClusterNetwork: V4GetClusterStatusResponseClusterNetwork,
    /**
     * The V4GetClusterStatusResponseClusterNodes model constructor.
     * @property {module:model/V4GetClusterStatusResponseClusterNodes}
     */
    V4GetClusterStatusResponseClusterNodes: V4GetClusterStatusResponseClusterNodes,
    /**
     * The V4GetClusterStatusResponseClusterResources model constructor.
     * @property {module:model/V4GetClusterStatusResponseClusterResources}
     */
    V4GetClusterStatusResponseClusterResources: V4GetClusterStatusResponseClusterResources,
    /**
     * The V4GetClusterStatusResponseClusterScaling model constructor.
     * @property {module:model/V4GetClusterStatusResponseClusterScaling}
     */
    V4GetClusterStatusResponseClusterScaling: V4GetClusterStatusResponseClusterScaling,
    /**
     * The V4GetClusterStatusResponseClusterVersions model constructor.
     * @property {module:model/V4GetClusterStatusResponseClusterVersions}
     */
    V4GetClusterStatusResponseClusterVersions: V4GetClusterStatusResponseClusterVersions,
    /**
