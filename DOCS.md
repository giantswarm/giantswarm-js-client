...
var api = new GiantSwarm.AuthTokensApi()
...
*GiantSwarm.NodepoolsApi* | [**getNodePoolStatus**](docs/NodepoolsApi.md#getNodePoolStatus) | **GET** /v5/clusters/{cluster_id}/nodepools/{nodepool_id}/status/ | Get node pool status
...
## Documentation for Models
 ...
 - [GiantSwarm.V5GetNodePoolStatusResponse](docs/V5GetNodePoolStatusResponse.md)
