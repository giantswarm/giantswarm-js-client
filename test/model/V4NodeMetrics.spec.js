...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4NodeMetrics();
  });
  ...
  describe('V4NodeMetrics', function() {
    it('should create an instance of V4NodeMetrics', function() {
      // uncomment below and update the code to test V4NodeMetrics
      //var instane = new GiantSwarmV4.V4NodeMetrics();
      //expect(instance).to.be.a(GiantSwarmV4.V4NodeMetrics);
    });
