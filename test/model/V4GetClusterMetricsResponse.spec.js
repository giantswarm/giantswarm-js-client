...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4GetClusterMetricsResponse();
  });
  ...
  describe('V4GetClusterMetricsResponse', function() {
    it('should create an instance of V4GetClusterMetricsResponse', function() {
      // uncomment below and update the code to test V4GetClusterMetricsResponse
      //var instane = new GiantSwarmV4.V4GetClusterMetricsResponse();
      //expect(instance).to.be.a(GiantSwarmV4.V4GetClusterMetricsResponse);
    });
