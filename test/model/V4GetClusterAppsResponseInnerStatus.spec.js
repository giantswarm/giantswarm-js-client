...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4GetClusterAppsResponseInnerStatus();
  });
  ...
  describe('V4GetClusterAppsResponseInnerStatus', function() {
    it('should create an instance of V4GetClusterAppsResponseInnerStatus', function() {
      // uncomment below and update the code to test V4GetClusterAppsResponseInnerStatus
      //var instane = new GiantSwarmV4.V4GetClusterAppsResponseInnerStatus();
      //expect(instance).to.be.a(GiantSwarmV4.V4GetClusterAppsResponseInnerStatus);
    });
