...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V5ClusterDetailsResponseVersions();
  });
  ...
  describe('V5ClusterDetailsResponseVersions', function() {
    it('should create an instance of V5ClusterDetailsResponseVersions', function() {
      ...
      //var instane = new GiantSwarmV4.V5ClusterDetailsResponseVersions();
      //expect(instance).to.be.a(GiantSwarmV4.V5ClusterDetailsResponseVersions);
    });
