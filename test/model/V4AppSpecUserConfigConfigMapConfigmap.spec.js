...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4AppSpecUserConfigConfigMapConfigmap();
  });
  ...
  describe('V4AppSpecUserConfigConfigMapConfigmap', function() {
    it('should create an instance of V4AppSpecUserConfigConfigMapConfigmap', function() {
      ...
      //var instane = new GiantSwarmV4.V4AppSpecUserConfigConfigMapConfigmap();
      //expect(instance).to.be.a(GiantSwarmV4.V4AppSpecUserConfigConfigMapConfigmap);
    });
