...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4GetNodePoolResponse();
  });
  ...
  describe('V4GetNodePoolResponse', function() {
    it('should create an instance of V4GetNodePoolResponse', function() {
      // uncomment below and update the code to test V4GetNodePoolResponse
      //var instane = new GiantSwarmV4.V4GetNodePoolResponse();
      //expect(instance).to.be.a(GiantSwarmV4.V4GetNodePoolResponse);
    });
