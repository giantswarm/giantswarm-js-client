...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4GetNodePoolResponseNodeSpec();
  });
  ...
  describe('V4GetNodePoolResponseNodeSpec', function() {
    it('should create an instance of V4GetNodePoolResponseNodeSpec', function() {
      // uncomment below and update the code to test V4GetNodePoolResponseNodeSpec
      //var instane = new GiantSwarmV4.V4GetNodePoolResponseNodeSpec();
      //expect(instance).to.be.a(GiantSwarmV4.V4GetNodePoolResponseNodeSpec);
    });
