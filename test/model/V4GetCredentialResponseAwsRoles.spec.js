...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarm.V4GetCredentialResponseAwsRoles();
  });
  ...
  describe('V4GetCredentialResponseAwsRoles', function() {
    it('should create an instance of V4GetCredentialResponseAwsRoles', function() {
      ...
      //var instance = new GiantSwarm.V4GetCredentialResponseAwsRoles();
      //expect(instance).to.be.a(GiantSwarm.V4GetCredentialResponseAwsRoles);
    });
