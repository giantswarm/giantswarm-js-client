...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4GetCredentialResponseAwsRoles();
  });
  ...
  describe('V4GetCredentialResponseAwsRoles', function() {
    it('should create an instance of V4GetCredentialResponseAwsRoles', function() {
      // uncomment below and update the code to test V4GetCredentialResponseAwsRoles
      //var instane = new GiantSwarmV4.V4GetCredentialResponseAwsRoles();
      //expect(instance).to.be.a(GiantSwarmV4.V4GetCredentialResponseAwsRoles);
    });
