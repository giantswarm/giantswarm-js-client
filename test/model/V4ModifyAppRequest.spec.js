...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4ModifyAppRequest();
  });
  ...
  describe('V4ModifyAppRequest', function() {
    it('should create an instance of V4ModifyAppRequest', function() {
      // uncomment below and update the code to test V4ModifyAppRequest
      //var instane = new GiantSwarmV4.V4ModifyAppRequest();
      //expect(instance).to.be.a(GiantSwarmV4.V4ModifyAppRequest);
    });
