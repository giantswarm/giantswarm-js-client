...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4GetCredentialResponseAws();
  });
  ...
  describe('V4GetCredentialResponseAws', function() {
    it('should create an instance of V4GetCredentialResponseAws', function() {
      ...
      //var instane = new GiantSwarmV4.V4GetCredentialResponseAws();
      //expect(instance).to.be.a(GiantSwarmV4.V4GetCredentialResponseAws);
    });
