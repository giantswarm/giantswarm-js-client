...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4AddNodePoolRequestNodeSpecKvm();
  });
  ...
  describe('V4AddNodePoolRequestNodeSpecKvm', function() {
    it('should create an instance of V4AddNodePoolRequestNodeSpecKvm', function() {
      // uncomment below and update the code to test V4AddNodePoolRequestNodeSpecKvm
      //var instane = new GiantSwarmV4.V4AddNodePoolRequestNodeSpecKvm();
      //expect(instance).to.be.a(GiantSwarmV4.V4AddNodePoolRequestNodeSpecKvm);
    });
