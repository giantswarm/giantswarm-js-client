...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4GetClusterStatusResponseAwsSubnet();
  });
  ...
  describe('V4GetClusterStatusResponseAwsSubnet', function() {
    it('should create an instance of V4GetClusterStatusResponseAwsSubnet', function() {
      // uncomment below and update the code to test V4GetClusterStatusResponseAwsSubnet
      //var instane = new GiantSwarmV4.V4GetClusterStatusResponseAwsSubnet();
      //expect(instance).to.be.a(GiantSwarmV4.V4GetClusterStatusResponseAwsSubnet);
    });
