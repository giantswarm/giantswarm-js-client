...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4ModifyAppRequestSpec();
  });
  ...
  describe('V4ModifyAppRequestSpec', function() {
    it('should create an instance of V4ModifyAppRequestSpec', function() {
      ...
      //var instane = new GiantSwarmV4.V4ModifyAppRequestSpec();
      //expect(instance).to.be.a(GiantSwarmV4.V4ModifyAppRequestSpec);
    });
