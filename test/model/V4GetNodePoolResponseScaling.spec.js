...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4GetNodePoolResponseScaling();
  });
  ...
  describe('V4GetNodePoolResponseScaling', function() {
    it('should create an instance of V4GetNodePoolResponseScaling', function() {
      // uncomment below and update the code to test V4GetNodePoolResponseScaling
      //var instane = new GiantSwarmV4.V4GetNodePoolResponseScaling();
      //expect(instance).to.be.a(GiantSwarmV4.V4GetNodePoolResponseScaling);
    });
