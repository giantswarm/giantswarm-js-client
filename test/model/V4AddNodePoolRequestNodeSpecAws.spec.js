...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4AddNodePoolRequestNodeSpecAws();
  });
  ...
  describe('V4AddNodePoolRequestNodeSpecAws', function() {
    it('should create an instance of V4AddNodePoolRequestNodeSpecAws', function() {
      // uncomment below and update the code to test V4AddNodePoolRequestNodeSpecAws
      //var instane = new GiantSwarmV4.V4AddNodePoolRequestNodeSpecAws();
      //expect(instance).to.be.a(GiantSwarmV4.V4AddNodePoolRequestNodeSpecAws);
    });
