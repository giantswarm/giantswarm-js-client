...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4AppSpecUserConfigConfigMap();
  });
  ...
  describe('V4AppSpecUserConfigConfigMap', function() {
    it('should create an instance of V4AppSpecUserConfigConfigMap', function() {
      ...
      //var instane = new GiantSwarmV4.V4AppSpecUserConfigConfigMap();
      //expect(instance).to.be.a(GiantSwarmV4.V4AppSpecUserConfigConfigMap);
    });
