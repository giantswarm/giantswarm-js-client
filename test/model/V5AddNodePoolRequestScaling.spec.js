...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarm.V5AddNodePoolRequestScaling();
  });
  ...
  describe('V5AddNodePoolRequestScaling', function() {
    it('should create an instance of V5AddNodePoolRequestScaling', function() {
      ...
      //var instance = new GiantSwarm.V5AddNodePoolRequestScaling();
      //expect(instance).to.be.a(GiantSwarm.V5AddNodePoolRequestScaling);
    });
