...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V5AddNodePoolRequestScaling();
  });
  ...
  describe('V5AddNodePoolRequestScaling', function() {
    it('should create an instance of V5AddNodePoolRequestScaling', function() {
      // uncomment below and update the code to test V5AddNodePoolRequestScaling
      //var instane = new GiantSwarmV4.V5AddNodePoolRequestScaling();
      //expect(instance).to.be.a(GiantSwarmV4.V5AddNodePoolRequestScaling);
    });
