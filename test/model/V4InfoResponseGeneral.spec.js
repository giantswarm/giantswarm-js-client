...
(function(root, factory) {
  ...
  describe('V4InfoResponseGeneral', () => {
    test('should create an instance of V4InfoResponseGeneral', () => {
    ...
    test(
      'should have the property installationName (base name: "installation_name")',
      () => {
    ...
    test(
      'should have the property datacenter (base name: "datacenter")',
      () => {
