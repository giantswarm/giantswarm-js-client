...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4AddNodePoolRequest();
  });
  ...
  describe('V4AddNodePoolRequest', function() {
    it('should create an instance of V4AddNodePoolRequest', function() {
      // uncomment below and update the code to test V4AddNodePoolRequest
      //var instane = new GiantSwarmV4.V4AddNodePoolRequest();
      //expect(instance).to.be.a(GiantSwarmV4.V4AddNodePoolRequest);
    });
