...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V5GetNodePoolResponseScaling();
  });
  ...
  describe('V5GetNodePoolResponseScaling', function() {
    it('should create an instance of V5GetNodePoolResponseScaling', function() {
      ...
      //var instane = new GiantSwarmV4.V5GetNodePoolResponseScaling();
      //expect(instance).to.be.a(GiantSwarmV4.V5GetNodePoolResponseScaling);
    });
