...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4InfoResponseWorkersStorageSizeGb();
  });
  ...
  describe('V4InfoResponseWorkersStorageSizeGb', function() {
    it('should create an instance of V4InfoResponseWorkersStorageSizeGb', function() {
      // uncomment below and update the code to test V4InfoResponseWorkersStorageSizeGb
      //var instane = new GiantSwarmV4.V4InfoResponseWorkersStorageSizeGb();
      //expect(instance).to.be.a(GiantSwarmV4.V4InfoResponseWorkersStorageSizeGb);
    });
