...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4AddClusterRequestScaling();
  });
  ...
  describe('V4AddClusterRequestScaling', function() {
    it('should create an instance of V4AddClusterRequestScaling', function() {
      // uncomment below and update the code to test V4AddClusterRequestScaling
      //var instane = new GiantSwarmV4.V4AddClusterRequestScaling();
      //expect(instance).to.be.a(GiantSwarmV4.V4AddClusterRequestScaling);
    });
