...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarm.V4AddClusterRequestScaling();
  });
  ...
  describe('V4AddClusterRequestScaling', function() {
    it('should create an instance of V4AddClusterRequestScaling', function() {
      ...
      //var instance = new GiantSwarm.V4AddClusterRequestScaling();
      //expect(instance).to.be.a(GiantSwarm.V4AddClusterRequestScaling);
    });
