...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V5GetNodePoolResponseNodeSpecVolumeSizesGb();
  });
  ...
  describe('V5GetNodePoolResponseNodeSpecVolumeSizesGb', function() {
    it('should create an instance of V5GetNodePoolResponseNodeSpecVolumeSizesGb', function() {
      ...
      //var instane = new GiantSwarmV4.V5GetNodePoolResponseNodeSpecVolumeSizesGb();
      //expect(instance).to.be.a(GiantSwarmV4.V5GetNodePoolResponseNodeSpecVolumeSizesGb);
    });
