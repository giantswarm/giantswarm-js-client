...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4InfoResponseWorkers();
  });
  ...
  describe('V4InfoResponseWorkers', function() {
    it('should create an instance of V4InfoResponseWorkers', function() {
      ...
      //var instane = new GiantSwarmV4.V4InfoResponseWorkers();
      //expect(instance).to.be.a(GiantSwarmV4.V4InfoResponseWorkers);
    });
    ...
    it('should have the property ramSizeGb (base name: "ram_size_gb")', function() {
      // uncomment below and update the code to test the property ramSizeGb
      //var instane = new GiantSwarmV4.V4InfoResponseWorkers();
      //expect(instance).to.be();
    });

    it('should have the property storageSizeGb (base name: "storage_size_gb")', function() {
      // uncomment below and update the code to test the property storageSizeGb
      //var instane = new GiantSwarmV4.V4InfoResponseWorkers();
      //expect(instance).to.be();
    });
