...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4GetClusterStatusResponseCluster();
  });
  ...
  describe('V4GetClusterStatusResponseCluster', function() {
    it('should create an instance of V4GetClusterStatusResponseCluster', function() {
      // uncomment below and update the code to test V4GetClusterStatusResponseCluster
      //var instane = new GiantSwarmV4.V4GetClusterStatusResponseCluster();
      //expect(instance).to.be.a(GiantSwarmV4.V4GetClusterStatusResponseCluster);
    });
