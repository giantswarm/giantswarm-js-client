...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4InfoResponseWorkersCpuCores();
  });
  ...
  describe('V4InfoResponseWorkersCpuCores', function() {
    it('should create an instance of V4InfoResponseWorkersCpuCores', function() {
      // uncomment below and update the code to test V4InfoResponseWorkersCpuCores
      //var instane = new GiantSwarmV4.V4InfoResponseWorkersCpuCores();
      //expect(instance).to.be.a(GiantSwarmV4.V4InfoResponseWorkersCpuCores);
    });
