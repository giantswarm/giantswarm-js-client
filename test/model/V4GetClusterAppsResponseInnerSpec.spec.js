...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4GetClusterAppsResponseInnerSpec();
  });
  ...
  describe('V4GetClusterAppsResponseInnerSpec', function() {
    it('should create an instance of V4GetClusterAppsResponseInnerSpec', function() {
      // uncomment below and update the code to test V4GetClusterAppsResponseInnerSpec
      //var instane = new GiantSwarmV4.V4GetClusterAppsResponseInnerSpec();
      //expect(instance).to.be.a(GiantSwarmV4.V4GetClusterAppsResponseInnerSpec);
    });
