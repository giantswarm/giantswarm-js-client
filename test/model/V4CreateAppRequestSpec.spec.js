...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4CreateAppRequestSpec();
  });
  ...
  describe('V4CreateAppRequestSpec', function() {
    it('should create an instance of V4CreateAppRequestSpec', function() {
      ...
      //var instane = new GiantSwarmV4.V4CreateAppRequestSpec();
      //expect(instance).to.be.a(GiantSwarmV4.V4CreateAppRequestSpec);
    });
