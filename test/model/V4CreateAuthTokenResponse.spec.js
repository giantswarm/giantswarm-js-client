...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4CreateAuthTokenResponse();
  });
  ...
  describe('V4CreateAuthTokenResponse', function() {
    it('should create an instance of V4CreateAuthTokenResponse', function() {
      ...
      //var instane = new GiantSwarmV4.V4CreateAuthTokenResponse();
      //expect(instance).to.be.a(GiantSwarmV4.V4CreateAuthTokenResponse);
    });
