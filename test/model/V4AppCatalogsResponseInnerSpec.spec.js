...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4AppCatalogsResponseInnerSpec();
  });
  ...
  describe('V4AppCatalogsResponseInnerSpec', function() {
    it('should create an instance of V4AppCatalogsResponseInnerSpec', function() {
      ...
      //var instane = new GiantSwarmV4.V4AppCatalogsResponseInnerSpec();
      //expect(instance).to.be.a(GiantSwarmV4.V4AppCatalogsResponseInnerSpec);
    });
