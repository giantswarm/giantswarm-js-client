...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4AppCatalogsResponseInner();
  });
  ...
  describe('V4AppCatalogsResponseInner', function() {
    it('should create an instance of V4AppCatalogsResponseInner', function() {
      ...
      //var instane = new GiantSwarmV4.V4AppCatalogsResponseInner();
      //expect(instance).to.be.a(GiantSwarmV4.V4AppCatalogsResponseInner);
    });
