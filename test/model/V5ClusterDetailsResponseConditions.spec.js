...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V5ClusterDetailsResponseConditions();
  });
  ...
  describe('V5ClusterDetailsResponseConditions', function() {
    it('should create an instance of V5ClusterDetailsResponseConditions', function() {
      // uncomment below and update the code to test V5ClusterDetailsResponseConditions
      //var instane = new GiantSwarmV4.V5ClusterDetailsResponseConditions();
      //expect(instance).to.be.a(GiantSwarmV4.V5ClusterDetailsResponseConditions);
    });
