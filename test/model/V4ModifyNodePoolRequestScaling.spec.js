...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4ModifyNodePoolRequestScaling();
  });
  ...
  describe('V4ModifyNodePoolRequestScaling', function() {
    it('should create an instance of V4ModifyNodePoolRequestScaling', function() {
      // uncomment below and update the code to test V4ModifyNodePoolRequestScaling
      //var instane = new GiantSwarmV4.V4ModifyNodePoolRequestScaling();
      //expect(instance).to.be.a(GiantSwarmV4.V4ModifyNodePoolRequestScaling);
    });
