...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4ModifyClusterRequestScaling();
  });
  ...
  describe('V4ModifyClusterRequestScaling', function() {
    it('should create an instance of V4ModifyClusterRequestScaling', function() {
      // uncomment below and update the code to test V4ModifyClusterRequestScaling
      //var instane = new GiantSwarmV4.V4ModifyClusterRequestScaling();
      //expect(instance).to.be.a(GiantSwarmV4.V4ModifyClusterRequestScaling);
    });
