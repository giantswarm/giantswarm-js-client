...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarm.V4ModifyClusterRequestScaling();
  });
  ...
  describe('V4ModifyClusterRequestScaling', function() {
    it('should create an instance of V4ModifyClusterRequestScaling', function() {
      ...
      //var instance = new GiantSwarm.V4ModifyClusterRequestScaling();
      //expect(instance).to.be.a(GiantSwarm.V4ModifyClusterRequestScaling);
    });
