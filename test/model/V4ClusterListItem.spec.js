...
(function(root, factory) {
  ...
  beforeEach(() => {
    instance = new GiantSwarm.V4ClusterListItem();
  });
  ...
  describe('V4ClusterListItem', () => {
    test('should create an instance of V4ClusterListItem', () => {
      // uncomment below and update the code to test V4ClusterListItem
      //var instane = new GiantSwarm.V4ClusterListItem();
      //expect(instance).to.be.a(GiantSwarm.V4ClusterListItem);
    });
    ...
    test('should have the property path (base name: "path")', () => {
