...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4ClusterListItem();
  });
  ...
  describe('V4ClusterListItem', function() {
    it('should create an instance of V4ClusterListItem', function() {
      // uncomment below and update the code to test V4ClusterListItem
      //var instane = new GiantSwarmV4.V4ClusterListItem();
      //expect(instance).to.be.a(GiantSwarmV4.V4ClusterListItem);
    });
