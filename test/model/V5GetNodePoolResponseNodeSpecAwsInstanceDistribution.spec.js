...
(function(root, factory) {
  ...
  beforeEach(() => {
    instance = new GiantSwarm.V5GetNodePoolResponseNodeSpecAwsInstanceDistribution();
  });
  ...
  describe('V5GetNodePoolResponseNodeSpecAwsInstanceDistribution', () => {
    test('should create an instance of V5GetNodePoolResponseNodeSpecAwsInstanceDistribution', () => {
      // uncomment below and update the code to test V5GetNodePoolResponseNodeSpecAwsInstanceDistribution
      //var instane = new GiantSwarm.V5GetNodePoolResponseNodeSpecAwsInstanceDistribution();
      //expect(instance).to.be.a(GiantSwarm.V5GetNodePoolResponseNodeSpecAwsInstanceDistribution);
    });
