...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4InfoResponseWorkersRamSizeGb();
  });
  ...
  describe('V4InfoResponseWorkersRamSizeGb', function() {
    it('should create an instance of V4InfoResponseWorkersRamSizeGb', function() {
      // uncomment below and update the code to test V4InfoResponseWorkersRamSizeGb
      //var instane = new GiantSwarmV4.V4InfoResponseWorkersRamSizeGb();
      //expect(instance).to.be.a(GiantSwarmV4.V4InfoResponseWorkersRamSizeGb);
    });
