...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4AddNodePoolRequestScaling();
  });
  ...
  describe('V4AddNodePoolRequestScaling', function() {
    it('should create an instance of V4AddNodePoolRequestScaling', function() {
      // uncomment below and update the code to test V4AddNodePoolRequestScaling
      //var instane = new GiantSwarmV4.V4AddNodePoolRequestScaling();
      //expect(instance).to.be.a(GiantSwarmV4.V4AddNodePoolRequestScaling);
    });
