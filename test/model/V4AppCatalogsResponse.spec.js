...
(function(root, factory) {
  ...
  beforeEach(() => {
    instance = new GiantSwarm.V4AppCatalogsResponse();
  });
  ...
  describe('V4AppCatalogsResponse', () => {
    test('should create an instance of V4AppCatalogsResponse', () => {
      // uncomment below and update the code to test V4AppCatalogsResponse
      //var instane = new GiantSwarm.V4AppCatalogsResponse();
      //expect(instance).to.be.a(GiantSwarm.V4AppCatalogsResponse);
    });
