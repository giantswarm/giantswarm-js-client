...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V4GetClusterStatusResponseAws();
  });
  ...
  describe('V4GetClusterStatusResponseAws', function() {
    it('should create an instance of V4GetClusterStatusResponseAws', function() {
      // uncomment below and update the code to test V4GetClusterStatusResponseAws
      //var instane = new GiantSwarmV4.V4GetClusterStatusResponseAws();
      //expect(instance).to.be.a(GiantSwarmV4.V4GetClusterStatusResponseAws);
    });
