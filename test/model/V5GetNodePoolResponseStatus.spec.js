...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.V5GetNodePoolResponseStatus();
  });
  ...
  describe('V5GetNodePoolResponseStatus', function() {
    it('should create an instance of V5GetNodePoolResponseStatus', function() {
      ...
      //var instane = new GiantSwarmV4.V5GetNodePoolResponseStatus();
      //expect(instance).to.be.a(GiantSwarmV4.V5GetNodePoolResponseStatus);
    });
