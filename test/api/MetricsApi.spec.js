...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiantSwarmV4.MetricsApi();
  });
  ...
  describe('MetricsApi', function() {
    describe('getClusterMetrics', function() {
      it('should call getClusterMetrics successfully', function(done) {
        //uncomment below and update the code to test getClusterMetrics
        //instance.getClusterMetrics(function(error) {
