...
* @version 4.0.0
*/
export default class V4AppCatalogsResponse extends Array<any> {
    /**
    ...
    */
   static constructFromObject(data: Partial<V4AppCatalogsResponse>, obj: V4AppCatalogsResponse): V4AppCatalogsResponse;
}
