...
type V4AppCatalogsResponse = Array < {
        'metadata' ? : {
            'name' ? : string
...
type V4GetClusterAppsResponse = Array < {
        'metadata' ? : {
            'name' ? : string
...
type V4GetKeyPairsResponse = Array < {
        'id' ? : string
...
type V4GetCredentialsResponse = Array < {
        'id' ? : string
...
type V5GetNodePoolsResponse = Array < {
        'id' ? : string
...
export default class GiantSwarm {
    ...
    */
    getAppCatalogs(parameters: {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (parameters['xRequestId'] !== undefined) {
                headers['X-Request-ID'] = parameters['xRequestId'];
            }

            if (parameters['xGiantSwarmActivity'] !== undefined) {
                headers['X-Giant-Swarm-Activity'] = parameters['xGiantSwarmActivity'];
            }

            if (parameters['xGiantSwarmCmdLine'] !== undefined) {
                headers['X-Giant-Swarm-CmdLine'] = parameters['xGiantSwarmCmdLine'];
            }
    ...
    */
    ...
    modifyPasswordURL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v4/users/{email}/password/';
    ...
    */
    ...
    getClusterURL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v4/clusters/{cluster_id}/';

        path = path.replace('{cluster_id}', `${parameters['clusterId']}`);
    ...
    getCluster(parameters: {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (parameters['clusterId'] === undefined) {
                reject(new Error('Missing required  parameter: clusterId'));
                return;
            }
    ...
    */
    ...
    getKeyPairsURL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v4/clusters/{cluster_id}/key-pairs/';
    ...
    */
    ...
    getClusterStatusURL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v4/clusters/{cluster_id}/status/';
    ...
    */
    ...
    getClusterAppsV4URL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v4/clusters/{cluster_id}/apps/';
    ...
    */
    ...
    deleteClusterAppV4URL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v4/clusters/{cluster_id}/apps/{app_name}/';

        path = path.replace('{cluster_id}', `${parameters['clusterId']}`);

        path = path.replace('{app_name}', `${parameters['appName']}`);
    ...
    */
    ...
    getClusterAppConfigV4URL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v4/clusters/{cluster_id}/apps/{app_name}/config/';
    ...
    */
    ...
    getClusterAppSecretV4URL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v4/clusters/{cluster_id}/apps/{app_name}/secret/';
    ...
    */
    ...
    getClusterAppsV5URL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v5/clusters/{cluster_id}/apps/';
    ...
    */
    ...
    deleteClusterAppV5URL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v5/clusters/{cluster_id}/apps/{app_name}/';
    ...
    */
    ...
    getClusterAppConfigV5URL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v5/clusters/{cluster_id}/apps/{app_name}/config/';
    ...
    */
    ...
    getClusterAppSecretV5URL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v5/clusters/{cluster_id}/apps/{app_name}/secret/';
    ...
    */
    ...
    getOrganizationURL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v4/organizations/{organization_id}/';
    ...
    */
    ...
    getCredentialsURL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v4/organizations/{organization_id}/credentials/';
    ...
    */
    ...
    getCredentialURL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v4/organizations/{organization_id}/credentials/{credential_id}/';

        path = path.replace('{organization_id}', `${parameters['organizationId']}`);

        path = path.replace('{credential_id}', `${parameters['credentialId']}`);
    ...
    */
    ...
    getClusterV5URL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v5/clusters/{cluster_id}/';
    ...
    */
    ...
    getNodePoolsURL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v5/clusters/{cluster_id}/nodepools/';
    ...
    */
    ...
    getNodePoolURL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v5/clusters/{cluster_id}/nodepools/{nodepool_id}/';

        path = path.replace('{cluster_id}', `${parameters['clusterId']}`);

        path = path.replace('{nodepool_id}', `${parameters['nodepoolId']}`);
    ...
    */
    getNodePool(parameters: {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (parameters['nodepoolId'] === undefined) {
                reject(new Error('Missing required  parameter: nodepoolId'));
                return;
            }
    ...
    */
    ...
    addExceptionNotificationURL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v5/exception-notifications/';
